...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f6c877de18f8f3578dc05cb9fe03d539964849f927ef5f17cbcfb2382fa16def.js',function(){input.required=false;search();});}
