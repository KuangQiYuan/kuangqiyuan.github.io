...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ac036bfde5a911a160fa8f79927346eb921644197e40f38a1cfb2a6e36ecf591.js',function(){input.required=false;search();});}
